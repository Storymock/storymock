...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message:
        'Released under the <a href="https://github.com/storymock/storymock/blob/main/LICENSE" target="_blank">MIT License</a>. Powered by <a href="https://github.com/faker-js/faker" target="_blank">@faker-js/faker</a>.',
      copyright:
